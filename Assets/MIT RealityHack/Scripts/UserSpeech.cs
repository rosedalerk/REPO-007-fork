...
/// </summary>
public class UserSpeech : MonoBehaviour
{
    ...
    */
    ...
    public OAICharacter character;
    
    [Serializable]
    public class OnRecognized : UnityEvent<string> {}
...
#region Speech Recognition event handlers
    ...
    private void RecognizedHandler(object sender, SpeechRecognitionEventArgs e)
    {
        if (e.Result.Reason == ResultReason.RecognizedSpeech)
        {
            ...
            Recognize(e.Result.Text);
            questionInput.text = e.Result.Text;
            lock (threadLocker)
            {
